...
SECRET_KEY = 'django-insecure-q@_&ph+tl_n+#(@ncx7m^6*#-&-^g+)0gge)%j()x#3=^4!y%@'
...
ALLOWED_HOSTS = [
    ...
    'cc2c-2407-4d00-2c04-8675-e531-778d-54c4-60a2.jp.ngrok.io'
]
...
LINE_CHANNEL_SECRET = '9d54c2ae89a6d88c2bd941476f3883d8'
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '[{levelname}][{asctime}][LINE:{lineno}][{module}]: {message}',
            'datefmt': '%Y-%m-%d %H:%M:%S',
            'style': '{',
        },
        'simple': {
